...
#Single Stack for easy copying to Linux Server

########################
### Base Profile
########################

# Check if linuxbrew exists and if so add to path
...
# Kerberos https://web.mit.edu/kerberos/krb5-latest/doc/basic/ccache_def.html
